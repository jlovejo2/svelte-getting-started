...
var app = (function (lifecycle) {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$5, 28, 0, 705);
    		},
    ...
    const file$4 = "src/common/BookCover.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span0, file$4, 98, 8, 2286);
    			attr_dev(span1, "class", "author svelte-15u0vgj");
    			add_location(span1, file$4, 99, 8, 2341);
    			...
    			add_location(span2, file$4, 97, 4, 2177);
    			attr_dev(a, "href", "#");
    			...
    			add_location(a, file$4, 96, 0, 2035);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class BookCover extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { book: 0 });
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 34, 16, 821);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
